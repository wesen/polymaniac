...
public class PixelRobotApp extends MidiApp {
	public PixelRobotApp(PApplet parent, MidiHandler midiHandler, MidiAppMapping[] mappings) {
		super(parent, midiHandler, mappings);
	}
	
	public PixelRobotApp(PApplet parent, MidiHandler midiHandler) {
		super(parent, midiHandler, PixelRobotApp.getDefaultMappings());
	}
	...
	public void setup() {
		robot.setScales( 15, 15);
		robot.setMargins( 0, 0);
		next();
	}
